...
sudo route add -net 0.0.0.0 gw 10.11.23.4 tap0 #WebServer
...
sudo route add -net 0.0.0.0 gw 10.11.23.4 tap4 #Host A
sudo route add -net 0.0.0.0 gw 10.134.1.3 tap5 #Host B
sudo route add -net 0.0.0.0 gw 192.168.53.3 tap6 #Host C
sudo route add -net 0.0.0.0 gw 10.134.1.1 tap7 #Telnet 1
